...
TOP_LEVEL_NAME="outAudioTest"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/anthony/intelFPGA_lite/20.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/outAudioTest/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_output/cadence/cao_fifo.v"                      -work outAudioTest -cdslib ./cds_libs/outAudioTest.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_output/cadence/cao_merge.v"                     -work outAudioTest -cdslib ./cds_libs/outAudioTest.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_output/cadence/cao_avalon.v"                    -work outAudioTest -cdslib ./cds_libs/outAudioTest.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_output/cadence/cao_registers.v"                 -work outAudioTest -cdslib ./cds_libs/outAudioTest.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_output/cadence/altera_cao_reset_synchronizer.v" -work outAudioTest -cdslib ./cds_libs/outAudioTest.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_output/cadence/clocked_audio_output.v"          -work outAudioTest -cdslib ./cds_libs/outAudioTest.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/outAudioTest.vhd"                                                                                                       
fi
