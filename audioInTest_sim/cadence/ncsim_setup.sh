...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_input/cadence/cai_avalon.v"                    -work audioInTest -cdslib ./cds_libs/audioInTest.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_input/cadence/cai_registers.v"                 -work audioInTest -cdslib ./cds_libs/audioInTest.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_input/cadence/altera_cai_reset_synchronizer.v" -work audioInTest -cdslib ./cds_libs/audioInTest.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/clocked_audio_input/cadence/clocked_audio_input.v"           -work audioInTest -cdslib ./cds_libs/audioInTest.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/audioInTest.vhd"                                                                                                     
fi
